      ...
      <div className="grid md:grid-cols-4 md:gap-5">
        ...
        <div className="md:col-span-3">
          {loading ? (
            ...
            >
              <h1 className="mb-4 text-xl">{`Editar Producto - ID: ${productId}`}</h1>
              <div className="mb-4">
              ...
              <div className="mb-4">
                <label htmlFor="slug">URL Semántica (Slug)</label>
                <input
                  type="text"
                  className="w-full"
                  id="slug"
                  {...register('slug', {
                    required: 'Por favor, introduce una URL/Slug',
                  })}
                />
                {errors.slug && (
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  id="price"
                  {...register('price', {
                    required: 'Por favor, introduce un precio al producto',
                  })}
                />
                {errors.price && (
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  {...register('countInStock', {
                    required: 'Por favor, ingresa una cantidad de stock',
                  })}
                />
                {errors.countInStock && (
