              ...
              {ratings &&
                ratings.map((rating) => (
                  <option key={rating} value={rating}>
                    {rating} Estrella{rating > 1 && 's'} & Arriba
                  </option>
                ))}
            </select>
          </div>
          ...
          <div className="mb-2 flex items-center justify-between border-b-2 pb-2">
            ...
            <div>
              ...
              <select value={sort} onChange={sortHandler}>
                ...
                <option value="lowest">Precio: Bajos a Altos</option>
                <option value="highest">Precio: Altos a Bajos</option>
                <option value="toprated">Opiniones de Compradores</option>
