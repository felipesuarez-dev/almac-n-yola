...
function OrderScreen() {
  ...
  function onApprove(data, actions) {
    return actions.order.capture().then(async function (details) {
      try {
        ...
        toast.success('El pedido fue pagado exitosamente');
      } catch (err) {
  ...
  async function deliverOrderHandler() {
    try {
      ...
      toast.success('El pedido fue despachado');
    } catch (err) {
        ...
        <div className="grid md:grid-cols-4 md:gap-5">
          <div className="overflow-x-auto md:col-span-3">
            <div className="card  p-5">
              ...
              {isDelivered ? (
                <div className="alert-success">Enviar a {deliveredAt}</div>
              ) : (
                <div className="alert-error">Sin despachar</div>
              )}
            </div>
            ...
            <div className="card p-5">
              ...
              {isPaid ? (
                ...
                <div className="alert-error">Sin pagar</div>
              )}
            </div>

            <div className="card overflow-x-auto p-5">
              <h2 className="mb-2 text-lg">Productos del pedido</h2>
